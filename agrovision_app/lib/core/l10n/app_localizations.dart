...
class AppLocalizations {
  ...
  String get navAssistant => tr('nav_assistant');
  ...
  String get aiAssistantTitle => tr('ai_assistant_title');

  String get aiAssistantSubtitle => tr('ai_assistant_subtitle');

  String get aiAssistantWelcome => tr('ai_assistant_welcome');

  String get aiAssistantWelcomeSubtitle => tr('ai_assistant_welcome_subtitle');

  String get typeYourQuestion => tr('type_your_question');

  String get newConversation => tr('new_conversation');

  String get clearConversation => tr('clear_conversation');

  String get clearConversationConfirm => tr('clear_conversation_confirm');

  String get suggestionsLabel => tr('suggestions_label');

  String get chatRetry => tr('chat_retry');

  String get scanContextLabel => tr('scan_context_label');

  String get messageCopied => tr('message_copied');

  String get askAboutScan => tr('ask_about_scan');
  String get cropDiseaseCareTitle => tr('crop_disease_care_title');
  String get cropDiseaseCareSubtitle => tr('crop_disease_care_subtitle');
  String get aiChatTitle => tr('ai_chat_title');
  String get aiChatSubtitle => tr('ai_chat_subtitle');
  String get askAiAssistant => tr('ask_ai_assistant');
  String get cropNameInputLabel => tr('crop_name_input_label');
  String get diseaseNameInputLabel => tr('disease_name_input_label');
  String get selectCropHint => tr('select_crop_hint');
  String get enterDiseaseHint => tr('enter_disease_hint');
  String get getRecommendationBtn => tr('get_recommendation_btn');
  String get generatingRecommendation => tr('generating_recommendation');
  String get diseaseOverviewLabel => tr('disease_overview_label');
  String get symptomsTitle => tr('symptoms_title');
  String get recommendedFertilizerTitle => tr('recommended_fertilizer_title');
  String get treatmentTitleLabel => tr('treatment_title_label');
  String get dosageTitle => tr('dosage_title');
  String get applicationTimingTitle => tr('application_timing_title');
  String get preventionTitle => tr('prevention_title');
  String get precautionsTitle => tr('precautions_title');
  String get askFollowUpChat => tr('ask_follow_up_chat');
  String get cropRequiredErr => tr('crop_required_err');
  String get diseaseRequiredErr => tr('disease_required_err');
  String get startChatBtn => tr('start_chat_btn');
  String get getAdviceBtn => tr('get_advice_btn');
  String get quickTopicsLabel => tr('quick_topics_label');
  String get homeAiBannerTitle => tr('home_ai_banner_title');
  String get homeAiBannerDesc => tr('home_ai_banner_desc');
  ...
  List<String> get chatSuggestions {
    ...
    final s1 = tr('chat_suggest_1');

    final s2 = tr('chat_suggest_2');

    final s3 = tr('chat_suggest_3');

    final s4 = tr('chat_suggest_4');

    final s5 = tr('chat_suggest_5');

    final s6 = tr('chat_suggest_6');
  ...
  String scanContextIntro(String crop, String disease, String severity) {

    return tr('scan_context_intro')

        .replaceAll('{0}', crop)

        .replaceAll('{1}', disease)

        .replaceAll('{2}', severity);
  ...
  static const Map<String, Map<String, String>> _translations = {
    ...
    'en': {
      ...
      'ai_assistant_title': 'AI Farmer Assistant',

      'ai_assistant_subtitle': 'Powered by Google Gemini',

      'ai_assistant_welcome': 'Hello, Farmer! 👋',

      'ai_assistant_welcome_subtitle': 'Ask me anything about your crops, diseases, fertilizers, or farming practices.',
      ...
      'clear_conversation_confirm': 'This will clear all messages in this conversation. Are you sure?',

      'suggestions_label': 'Suggested questions:',

      'chat_retry': 'Retry',

      'scan_context_label': 'Scan context:',

      'message_copied': 'Message copied',

      'ask_about_scan': 'Ask AI about this scan',

      'scan_context_intro': 'I just scanned my {0} plant and the result shows {1} with {2} severity. What should I do?',

      'chat_suggest_1': '🌿 My leaves are turning yellow',

      'chat_suggest_2': '🐛 How to control pests organically?',

      'chat_suggest_3': '💧 How often should I water my crops?',

      'chat_suggest_4': '🌾 What fertilizer is best for rice?',

      'chat_suggest_5': '🍃 How to prevent leaf diseases?',

      'chat_suggest_6': '☀️ What are signs of nutrient deficiency?',
      'crop_disease_care_title': 'Crop & Disease Care',
      'crop_disease_care_subtitle': 'Enter a crop and disease to get fertilizer, treatment and prevention recommendations.',
      'ai_chat_title': 'AI Chat',
      'ai_chat_subtitle': 'Ask anything about farming, crops, pests, soil, fertilizer and cultivation.',
      'ask_ai_assistant': 'Ask AI Assistant',
      'crop_name_input_label': 'Crop Name',
      'disease_name_input_label': 'Disease / Problem',
      'select_crop_hint': 'Select or enter crop (e.g. Blackgram)',
      'enter_disease_hint': 'Enter disease name (e.g. Powdery Mildew)',
      'get_recommendation_btn': 'Get Recommendation',
      'generating_recommendation': 'Consulting agricultural AI & database...',
      'disease_overview_label': 'Disease Overview',
      'symptoms_title': 'Symptoms',
      'recommended_fertilizer_title': 'Recommended Fertilizer & Nutrients',
      'treatment_title_label': 'Treatment Plan',
      'dosage_title': 'Dosage',
      'application_timing_title': 'Application Timing & Method',
      'prevention_title': 'Prevention & Cultural Practices',
      'precautions_title': 'Safety Precautions',
      'ask_follow_up_chat': 'Ask Follow-up in AI Chat',
      'crop_required_err': 'Please select or enter a crop name',
      'disease_required_err': 'Please enter a disease or symptom name',
      'start_chat_btn': 'Start Chat',
      'get_advice_btn': 'Get Advice',
      'quick_topics_label': 'Quick Topics',
      'home_ai_banner_title': 'AI Agricultural Assistant',
      'home_ai_banner_desc': 'Ask questions about crops, diseases, fertilizer, treatment and farming.',
      'ai_chat_history_label': 'Previous AI Conversations',
      'select_or_enter_crop': 'Select or Enter Crop',
    ...
    'ta': {
      ...
      'ai_assistant_title': 'AI விவசாய உதவியாளர்',

      'ai_assistant_subtitle': 'Google Gemini மூலம் இயக்கப்படுகிறது',

      'ai_assistant_welcome': 'வணக்கம், விவசாயி! 👋',

      'ai_assistant_welcome_subtitle': 'பயிர்கள், நோய்கள், உரங்கள் அல்லது விவசாய முறைகள் பற்றி என்னிடம் கேளுங்கள்.',

      'type_your_question': 'உங்கள் கேள்வியை தட்டச்சு செய்யுங்கள்...',

      'new_conversation': 'புதிய உரையாடல்',

      'clear_conversation': 'உரையாடலை அழி',

      'clear_conversation_confirm': 'இந்த உரையாடலின் அனைத்து செய்திகளும் அழிக்கப்படும். நிச்சயமாகவா?',

      'suggestions_label': 'பரிந்துரைக்கப்பட்ட கேள்விகள்:',

      'chat_retry': 'மீண்டும் முயற்சி',

      'scan_context_label': 'ஸ்கேன் முடிவு:',

      'message_copied': 'செய்தி நகலெடுக்கப்பட்டது',

      'ask_about_scan': 'இந்த ஸ்கேன் பற்றி AI-ஐக் கேளுங்கள்',

      'scan_context_intro': 'என் {0} செடியை ஸ்கேன் செய்தேன், {2} தீவிரத்தில் {1} கண்டுபிடிக்கப்பட்டது. என்ன செய்ய வேண்டும்?',

      'chat_suggest_1': '🌿 என் இலைகள் மஞ்சளாக மாறுகின்றன',

      'chat_suggest_2': '🐛 பூச்சிகளை இயற்கையாக எப்படி கட்டுப்படுத்துவது?',

      'chat_suggest_3': '💧 என் பயிர்களுக்கு எத்தனை நாட்களுக்கு ஒருமுறை நீர் பாய்ச்சவேண்டும்?',

      'chat_suggest_4': '🌾 நெல் பயிருக்கு சிறந்த உரம் எது?',

      'chat_suggest_5': '🍃 இலை நோய்களை எவ்வாறு தடுப்பது?',

      'chat_suggest_6': '☀️ ஊட்டச்சத்து குறைபாட்டின் அறிகுறிகள் என்ன?',
      'crop_disease_care_title': 'பயிர் & நோய் பராமரிப்பு',
      'crop_disease_care_subtitle': 'உரம், சிகிச்சை மற்றும் தடுப்பு பரிந்துரைகளைப் பெற பயிர் மற்றும் நோயை உள்ளிடவும்.',
      'ai_chat_title': 'AI அரட்டை',
      'ai_chat_subtitle': 'விவசாயம், பயிர்கள், பூச்சிகள், மண், உரம் மற்றும் சாகுபடி பற்றி என்னிடமும் கேளுங்கள்.',
      'ask_ai_assistant': 'AI உதவியாளரிடம் கேளுங்கள்',
      'crop_name_input_label': 'பயிரின் பெயர்',
      'disease_name_input_label': 'நோய் / பிரச்சனை',
      'select_crop_hint': 'பயிரைத் தேர்ந்தெடுக்கவும் (எ.கா. உளுந்து)',
      'enter_disease_hint': 'நோயின் பெயரை உள்ளிடவும் (எ.கா. சாம்பல் நோய்)',
      'get_recommendation_btn': 'பரிந்துரையைப் பெறுங்கள்',
      'generating_recommendation': 'விவசாய AI பரிந்துரையைப் பெறுகிறது...',
      'disease_overview_label': 'நோய் கண்ணோட்டம்',
      'symptoms_title': 'அறிகுறிகள்',
      'recommended_fertilizer_title': 'பரிந்துரைக்கப்பட்ட உரம் & ஊட்டச்சத்து',
      'treatment_title_label': 'சிகிச்சை திட்டம்',
      'dosage_title': 'மருந்தின் அளவு',
      'application_timing_title': 'பயன்படுத்தும் நேரம் & முறை',
      'prevention_title': 'தடுப்பு & பாதுகாப்பு முறைகள்',
      'precautions_title': 'முன்னெச்சரிக்கைகள்',
      'ask_follow_up_chat': 'AI அரட்டையில் கூடுதல் கேள்வி கேளுங்கள்',
      'crop_required_err': 'பயிரின் பெயரைத் தேர்ந்தெடுக்கவும் அல்லது உள்ளிடவும்',
      'disease_required_err': 'நோயின் பெயரை உள்ளிடவும்',
      'start_chat_btn': 'அரட்டையைத் தொடங்கு',
      'get_advice_btn': 'ஆலோசனை பெறுங்கள்',
      'quick_topics_label': 'விரைவு தலைப்புகள்',
      'home_ai_banner_title': 'AI விவசாய உதவியாளர்',
      'home_ai_banner_desc': 'பயிர்கள், நோய்கள், உரம், சிகிச்சை மற்றும் விவசாய முறைகள் பற்றி கேளுங்கள்.',
      'ai_chat_history_label': 'முந்தைய AI உரையாடல்கள்',
      'select_or_enter_crop': 'பயிரைத் தேர்ந்தெடுக்கவும்',
    ...
    'hi': {
      ...
      'ai_assistant_title': 'AI किसान सहायक',

      'ai_assistant_subtitle': 'Google Gemini द्वारा संचालित',

      'ai_assistant_welcome': 'नमस्ते, किसान! 👋',

      'ai_assistant_welcome_subtitle': 'फसलों, रोगों, खाद या खेती के तरीकों के बारे में मुझसे कुछ भी पूछें।',

      'type_your_question': 'अपना प्रश्न टाइप करें...',

      'new_conversation': 'नई वार्तालाप',

      'clear_conversation': 'चैट साफ़ करें',

      'clear_conversation_confirm': 'इस वार्तालाप के सभी संदेश हटा दिए जाएंगे। क्या आप निश्चित हैं?',

      'suggestions_label': 'सुझाव प्रश्न:',

      'chat_retry': 'पुनः प्रयास करें',

      'scan_context_label': 'स्कैन परिणाम:',

      'message_copied': 'संदेश कॉपी किया गया',

      'ask_about_scan': 'इस स्कैन के बारे में AI से पूछें',

      'scan_context_intro': 'मैंने अपने {0} पौधे को स्कैन किया और {2} गंभीरता के साथ {1} पाया गया। क्या करें?',

      'chat_suggest_1': '🌿 मेरे पत्ते पीले हो रहे हैं',

      'chat_suggest_2': '🐛 कीटों को जैविक तरीके से कैसे नियंत्रित करें?',

      'chat_suggest_3': '💧 फसलों को कितने दिन बाद पानी देना चाहिए?',

      'chat_suggest_4': '🌾 धान के लिए सबसे अच्छा खाद कौन सा है?',

      'chat_suggest_5': '🍃 पत्ते की बीमारियों को कैसे रोकें?',

      'chat_suggest_6': '☀️ पोषक तत्व की कमी के संकेत क्या हैं?',
      'crop_disease_care_title': 'फसल और रोग देखभाल',
      'crop_disease_care_subtitle': 'उर्वरक, उपचार और रोकथाम की सिफारिशों के लिए फसल और रोग दर्ज करें।',
      'ai_chat_title': 'AI चैट',
      'ai_chat_subtitle': 'खेती, फसलों, कीटों, मिट्टी, उर्वरक और खेती के तरीकों के बारे में कुछ भी पूछें।',
      'ask_ai_assistant': 'AI सहायक से पूछें',
      'crop_name_input_label': 'फसल का नाम',
      'disease_name_input_label': 'रोग / समस्या',
      'select_crop_hint': 'फसल चुनें या दर्ज करें (उदा. उड़द)',
      'enter_disease_hint': 'रोग का नाम दर्ज करें (उदा. चूर्णिल आसिता)',
      'get_recommendation_btn': 'सिफारिश प्राप्त करें',
      'generating_recommendation': 'कृषि AI सिफारिश तैयार कर रहा है...',
      'disease_overview_label': 'रोग का विवरण',
      'symptoms_title': 'लक्षण',
      'recommended_fertilizer_title': 'अनुशंसित उर्वरक और पोषक तत्व',
      'treatment_title_label': 'उपचार योजना',
      'dosage_title': 'मात्रा / खुराक',
      'application_timing_title': 'प्रयोग का समय और तरीका',
      'prevention_title': 'रोकथाम और सुरक्षा के उपाय',
      'precautions_title': 'सावधानियां',
      'ask_follow_up_chat': 'AI चैट में अतिरिक्त प्रश्न पूछें',
      'crop_required_err': 'कृपया फसल का नाम चुनें या दर्ज करें',
      'disease_required_err': 'कृपया रोग का नाम दर्ज करें',
      'start_chat_btn': 'चैट शुरू करें',
      'get_advice_btn': 'सलाह प्राप्त करें',
      'quick_topics_label': 'त्वरित विषय',
      'home_ai_banner_title': 'AI कृषि सहायक',
      'home_ai_banner_desc': 'फसलों, रोगों, उर्वरकों, उपचार और खेती के बारे में प्रश्न पूछें।',
      'ai_chat_history_label': 'पिछली AI बातचीत',
      'select_or_enter_crop': 'फसल चुनें या दर्ज करें',
    ...
    'ml': {
      ...
      // AI Chat Malayalam
      'ai_assistant_title': 'AI കാർഷിക അസിസ്റ്റന്റ്',
      'ai_assistant_subtitle': 'Google Gemini നൽകുന്ന കരുത്ത്',
      'ai_assistant_welcome': 'നമസ്കാരം, കർഷക സുഹൃത്തേ! 👋',
      'ai_assistant_welcome_subtitle': 'വിളകൾ, രോഗങ്ങൾ, വളങ്ങൾ, കൃഷിരീതികൾ എന്നിവയെക്കുറിച്ച് എന്തും ചോദിക്കാം.',
      'type_your_question': 'ചോദ്യം ടൈപ്പ് ചെയ്യുക...',
      'new_conversation': 'പുതിയ സംഭാഷണം',
      'clear_conversation': 'ചാറ്റ് മായ്‌ക്കുക',
      'clear_conversation_confirm': 'ഈ സംഭാഷണത്തിലെ എല്ലാ സന്ദേശങ്ങളും മായ്‌ക്കപ്പെടും. ഉറപ്പാണോ?',
      'suggestions_label': 'നിർദ്ദേശിച്ച ചോദ്യങ്ങൾ:',
      'chat_retry': 'വീണ്ടും ശ്രമിക്കുക',
      'scan_context_label': 'സ്കാൻ ഫലം:',
      'message_copied': 'സന്ദേശം പകർത്തി',
      'ask_about_scan': 'ഈ സ്കാനിനെക്കുറിച്ച് ചോദിക്കുക',
      'scan_context_intro': 'ഞാൻ എന്റെ {0} ചെടി സ്കാൻ ചെയ്തു, {2} തീവ്രതയോടെ {1} കണ്ടെത്തി. ഞാൻ എന്ത് ചെയ്യണം?',
      'chat_suggest_1': '🌿 എന്റെ ഇലകൾ മഞ്ഞനിറമാകുന്നു',
      'chat_suggest_2': '🐛 കീടങ്ങളെ ജൈവരീതിയിൽ എങ്ങനെ നിയന്ത്രിക്കാം?',
      'chat_suggest_3': '💧 എത്ര ദിവസത്തിലൊരിക്കൽ നനയ്ക്കണം?',
      'chat_suggest_4': '🌾 നെല്ലിന് ഏറ്റവും അനുയോജ്യമായ വളം ഏതാണ്?',
      'chat_suggest_5': '🍃 ഇല രോഗങ്ങളെ എങ്ങനെ തടയാം?',
      'chat_suggest_6': '☀️ പോഷകക്കുറവിന്റെ ലക്ഷണങ്ങൾ എന്തൊക്കെയാണ്?',
      'crop_disease_care_title': 'വിള & രോഗ പരിചരണം',
      'crop_disease_care_subtitle': 'വളം, ചികിത്സ, പ്രതിരോധ ശുപാർശകൾ എന്നിവ ലഭിക്കാൻ വിളയും രോഗവും നൽകുക.',
      'ai_chat_title': 'AI ചാറ്റ്',
      'ai_chat_subtitle': 'കൃഷി, വിളകൾ, കീടങ്ങൾ, മണ്ണ്, വളം എന്നിവയെക്കുറിച്ച് എന്തും ചോദിക്കാം.',
      'ask_ai_assistant': 'AI അസിസ്റ്റന്റിനോട് ചോദിക്കുക',
      'crop_name_input_label': 'വിളയുടെ പേര്',
      'disease_name_input_label': 'രോഗം / പ്രശ്നം',
      'select_crop_hint': 'വിള തിരഞ്ഞെടുക്കുക (ഉദാ: ഉഴുന്ന്)',
      'enter_disease_hint': 'രോഗത്തിന്റെ പേര് നൽകുക (ഉദാ: ചാരപ്പൂപ്പ്)',
      'get_recommendation_btn': 'ശുപാർശ നേടുക',
      'generating_recommendation': 'കാർഷിക AI ശുപാർശ തയ്യാറാക്കുന്നു...',
      'disease_overview_label': 'രോഗ വിവരണം',
      'symptoms_title': 'ലക്ഷണങ്ങൾ',
      'recommended_fertilizer_title': 'ശുപാർശ ചെയ്ത വളവും പോഷകങ്ങളും',
      'treatment_title_label': 'ചികിത്സാ പദ്ധതി',
      'dosage_title': 'അളവ് / ഡോസ്',
      'application_timing_title': 'പ്രയോഗിക്കുന്ന സമയവും രീതിയും',
      'prevention_title': 'പ്രതിരോധ നടപടികൾ',
      'precautions_title': 'സുരക്ഷാ മുൻകരുതലുകൾ',
      'ask_follow_up_chat': 'AI ചാറ്റിൽ കൂടുതൽ ചോദിക്കുക',
      'crop_required_err': 'വിളയുടെ പേര് തിരഞ്ഞെടുക്കുകയോ നൽകുകയോ ചെയ്യുക',
      'disease_required_err': 'രോഗത്തിന്റെ പേര് നൽകുക',
      'start_chat_btn': 'ചാറ്റ് ആരംഭിക്കുക',
      'get_advice_btn': 'ഉപദേശം നേടുക',
      'quick_topics_label': 'പ്രധാന വിഷയങ്ങൾ',
      'home_ai_banner_title': 'AI കാർഷിക അസിസ്റ്റന്റ്',
      'home_ai_banner_desc': 'വിളകൾ, രോഗങ്ങൾ, വളം, ചികിത്സ, കൃഷി രീതികൾ എന്നിവയെക്കുറിച്ച് ചോദിക്കുക.',
      'ai_chat_history_label': 'മുൻകാല AI സംഭാഷണങ്ങൾ',
      'select_or_enter_crop': 'വിള തിരഞ്ഞെടുക്കുക',
